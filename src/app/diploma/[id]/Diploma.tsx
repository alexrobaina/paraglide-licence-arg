  ...
  return (
    <main className="diploma-page mx-auto max-w-3xl px-4 py-10">
      ...
      >
        ...
        <p className="mt-8 text-sm text-neutral-500">{t('dip.certifies')}</p>
        ...
        <p className="mx-auto mt-4 max-w-md text-sm text-neutral-600">
          {t('dip.passedExam')} <strong>{examTitle}</strong>
          {t('dip.scoring')} <strong>{score}</strong>{' '}
          {t('dip.outOf', { max: maxScore })}.
        </p>
        ...
        <div className="mt-10 flex items-end justify-between text-xs text-neutral-500">
          <div className="text-left">
            <div className="border-t border-neutral-300 pt-1">{t('dip.date')}</div>
          ...
          <div className="text-right">
            ...
            <div className="mt-1 text-neutral-700">{t('dip.signature')}</div>
          </div>
        </div>
      </div>
    </main>
